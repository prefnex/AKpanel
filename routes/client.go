...
func registerClientRoutes(clientController *controllers.ClientController) {
	...
	facades.Route().Post("/api/client/dns/record/update", clientController.UpdateDNSRecord)
	...
	facades.Route().Get("/api/client/files/subdirs", clientController.FilesSubdirs)
	...
	facades.Route().Post("/api/client/files/copy", clientController.FilesCopy)
	facades.Route().Post("/api/client/files/move", clientController.FilesMove)
	facades.Route().Post("/api/client/files/duplicate", clientController.FilesDuplicate)
	facades.Route().Post("/api/client/files/archive", clientController.CompressArchive)
	...
	facades.Route().Post("/api/client/files/remote-download", clientController.FilesRemoteDownload)
	facades.Route().Post("/api/client/files/grep", clientController.FilesGrep)
	facades.Route().Get("/api/client/files/search", clientController.SearchFiles)
	facades.Route().Get("/api/client/files/checksum", clientController.FilesChecksum)
	facades.Route().Get("/api/client/files/dirsize", clientController.FilesDirSize)
	facades.Route().Post("/api/client/files/permissions", clientController.FilesFixPermissions)
	facades.Route().Get("/api/client/files/download", clientController.FilesDownload)
	facades.Route().Post("/api/client/files/upload", clientController.FilesUpload)
